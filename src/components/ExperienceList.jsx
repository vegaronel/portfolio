...
function ExperienceList() {
  return (
    <div>
          ...
          <Card
            key={index}
            className="w-full border-0 dark:hover:bg-slate-900 hover:bg-slate-200 bg-slate-100 dark:bg-slate-950 cursor-pointer transition-all duration-400 hover:shadow-2xl shadow-purple-50"
          >
            <CardHeader>
