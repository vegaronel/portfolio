...
const PLANE_WIDTH_FACTOR = 1200;
const PLANE_HEIGHT_FACTOR = 750;
...
class Media {
  ...
  onResize({ screen, viewport } = {}) {
    ...
    this.plane.scale.y =
      (this.viewport.height * (PLANE_HEIGHT_FACTOR * this.scale)) /
      this.screen.height;
    this.plane.scale.x =
      (this.viewport.width * (PLANE_WIDTH_FACTOR * this.scale)) /
      this.screen.width;
