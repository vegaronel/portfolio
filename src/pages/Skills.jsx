    ...
    <div className="w-full space-y-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        {skillIcons.map((item, index) => (
          <div key={index} className="flex gap-2 items-center rounded-xl hover:bg-slate-200 dark:hover:bg-slate-800 cursor-pointer duration-300 px-3 py-1 transition-all">
